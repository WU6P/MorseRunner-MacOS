...
type
  ...
  public
    ...
    class function compareCall(constref left, right: TCqWwCallRec) : integer; static;
  end;
...
begin
  ...
  try
    ...
    slst.LoadFromFile(GetDataPath.GetDataPath + 'CQWWCW.TXT');
...
class function TCqWwCallRec.compareCall(constref left, right: TCqWwCallRec) : integer;
begin
