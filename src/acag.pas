...
type
  ...
  public
    ...
    class function compareCall(constref left, right: TAcagCallRec) : integer; static;
  end;
...
begin
  ...
  try
    ...
    slst.LoadFromFile(GetDataPath.GetDataPath + 'JARL_ACAG.TXT');
...
class function TAcagCallRec.compareCall(constref left, right: TAcagCallRec) : integer;
begin
