...
uses
  StrUtils,
  Generics.Defaults, Generics.Collections, Contest, DxStn, Log, GetDataPath;
...
type
  ...
  public
    ...
    class function compareCall(constref left, right: TAllJaCallRec) : integer; static;
  end;
...
begin
  ...
  try
    ...
    slst.LoadFromFile(GetDataPath.GetDataPath + 'JARL_ALLJA.TXT');
...
class function TAllJaCallRec.compareCall(constref left, right: TAllJaCallRec) : integer;
begin
