...
type
    ...
    public
        ...
        class function compareCall(constref left, right: TCWSSTRec) : integer; static;
    end;
...
begin
    ...
    try
        ...
        slst.LoadFromFile(GetDataPath.GetDataPath + 'K1USNSST.txt');
        slst.Sort;
...
class function TCWSSTRec.compareCall(constref left, right: TCWSSTRec) : integer;
begin
