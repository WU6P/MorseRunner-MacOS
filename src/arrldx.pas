...
type
  ...
  public
    ...
    class function compareCall(constref left, right: TArrlDxCallRec) : integer; static;
  end;
...
begin
  ...
  try
    ...
    slst.LoadFromFile(GetDataPath.GetDataPath + 'ARRLDXCW_USDX.txt');
...
class function TArrlDxCallRec.compareCall(constref left, right: TArrlDxCallRec) : integer;
begin
