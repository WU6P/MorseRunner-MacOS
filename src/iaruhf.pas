...
type
  ...
  public
    ...
    class function compareCall(constref left, right: TIaruHfCallRec) : integer; static;
  end;
...
begin
  ...
  try
    ...
    slst.LoadFromFile(GetDataPath.GetDataPath + 'IARU_HF.txt');
...
class function TIaruHfCallRec.compareCall(constref left, right: TIaruHfCallRec) : integer;
begin
