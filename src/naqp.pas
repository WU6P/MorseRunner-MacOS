...
uses
  Generics.Defaults, Generics.Collections, ExchFields, DualExchContest, DxStn, Log,
  Station, GetDataPath;
...
type
  ...
  public
    ...
    class function compareCall(constref left, right: TNaQpCallRec) : integer; static;
  end;
...
public
  ...
  function IsCallLocalToContest(const ACallsign: string) : boolean; override;
...
{$endif}
  ...
  try
    ...
    slst.LoadFromFile(GetDataPath.GetDataPath + 'NAQPCW.TXT');
...
class function TNaQpCallRec.compareCall(constref left, right: TNaQpCallRec) : integer;
begin
