...
type
    ...
    public
        ...
        class function compareCall(constref left, right: TCWOPSRec) : integer; static;
    end;
...
begin
    ...
    try
        ...
        slst.LoadFromFile(GetDataPath.GetDataPath + 'CWOPS.LIST');
...
class function TCWOPSRec.compareCall(constref left, right: TCWOPSRec) : integer;
begin
