...
uses
  ...
  Log,      // for TQso
  SSExchParser,
  Contest, Station, DxStn, GetDataPath;
...
type
  ...
  public
    ...
    class function compareCall(constref left, right: TSweepstakesCallRec) : integer; static;
  end;
...
public
  ...
  function GetCheckSection(const ACallsign: string; AThreshold: Single = 0): String; override;
...
begin
  ...
  try
    slst.LoadFromFile(GetDataPath.GetDataPath + 'SSCW.TXT');
...
class function TSweepstakesCallRec.compareCall(constref left, right: TSweepstakesCallRec) : integer;
begin
